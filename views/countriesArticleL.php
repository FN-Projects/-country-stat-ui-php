<div class="countryTable">
    <div class="table-responsive rounded p-1 mt-3">
        <table id="countryArticleLData" class="table table-striped table-hover rounded-lg border border-table bg-white">
            ...
            <tbody>
                <?php foreach ($countriesArticleL as $country) : extract($country) ?>
                    <tr>
                        <td><?= $country_id ?></td>
