<div class="countryTable">
    <div class="table-responsive rounded p-1 mt-3">
        <table id="countryArticleLeData" class="table table-striped table-hover rounded-lg border border-table bg-white">
            ...
            <tbody>
                <?php foreach ($countriesArticleLe as $country) : extract($country) ?>
                    <tr>
                        <td><?= $country_id ?></td>
